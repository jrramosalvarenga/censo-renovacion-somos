...
<table>
    <thead>
        <tr><th>Municipio</th><th>Total</th><th>Militantes</th><th>Simpatizantes</th></tr>
    </thead>
    <tbody>
    @foreach($municipios as $mun)
    <tr>
        <td>{{ $mun->nombre }}</td>
        <td>{{ $mun->miembros_count }}</td>
        <td>{{ $mun->militantes_count }}</td>
        <td>{{ $mun->miembros_count - $mun->militantes_count }}</td>
    </tr>
    @endforeach
    </tbody>
</table>
